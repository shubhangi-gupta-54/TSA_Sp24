...
energy_data1 <- read_excel("./Data/Table_10.1_Renewable_Energy_Production_and_Consumption_by_Source.XLS",skip = 12, sheet="Monthly Data",col_names=FALSE) 
...
#assigning the column names to the data columns
...
# this is to make sure that a decimal separator is . and not ,
